...
<article class="grid-container">
      <div class="grid-x grid-margin-x">
        ...
        <div class="show-for-large large-3 cell">
          <img src="${path2 }/resources/img/7.png" alt="picture of space">
        </div>
    ...
    <div class="grid-x grid-margin-x small-up-1 medium-up-2 large-up-3">
      <div class="cell">
        <div class="callout">
          <p>Pegasi B</p>
          <p class="pic"><img src="${path2 }/resources/img/1.png" alt="image of a planet called Pegasi B"></p>
      ...
      <div class="cell">
        <div class="callout">
          <p>Pegasi B</p>
          <p class="pic"><img src="${path2 }/resources/img/2.jpg" alt="image of a planet called Pegasi B"></p>
          <p class="lead">Copernican Revolution caused an uproar</p>
          <p class="subheader">Find Earth-like planets life outside the Solar System</p>
        </div>
      </div>
      <div class="cell">
        <div class="callout">
          <p>Pegasi B</p>
          <p class="pic"><img src="${path2 }/resources/img/3.jpg" alt="image of a planet called Pegasi B"></p>
          <p class="lead">Copernican Revolution caused an uproar</p>
          <p class="subheader">Find Earth-like planets life outside the Solar System</p>
        </div>
      </div>
      <div class="cell">
        <div class="callout">
          <p>Pegasi B</p>
          <p class="pic"><img src="${path2 }/resources/img/4.jpg" alt="image of a planet called Pegasi B"></p>
          <p class="lead">Copernican Revolution caused an uproar</p>
          <p class="subheader">Find Earth-like planets life outside the Solar System</p>
        </div>
      </div>
      <div class="cell">
        <div class="callout">
          <p>Pegasi B</p>
          <p class="pic"><img src="${path2 }/resources/img/5.jpg" alt="image of a planet called Pegasi B"></p>
          <p class="lead">Copernican Revolution caused an uproar</p>
          <p class="subheader">Find Earth-like planets life outside the Solar System</p>
        </div>
      </div>
      <div class="cell">
        <div class="callout">
          <p>Pegasi B</p>
          <p class="pic"><img src="${path2 }/resources/img/6.jpg" alt="image of a planet called Pegasi B"></p>
          <p class="lead">Copernican Revolution caused an uproar</p>
          <p class="subheader">Find Earth-like planets life outside the Solar System</p>
        </div>
      </div>
